...
SNAPSHOTS_JSON = ['{"datetime": "1576237612000", '
                  ...
                  '"color_image": '
                    '{"width": 10, '
                    '"height": 20, '
                    '"data": "tmpdir/raw_data/49/1576237612000/color_image"}, '
                  '"depth_image": '
                    '{"width": 5, '
                    '"height": 7, '
                    '"data": "tmpdir/raw_data/49/1576237612000/depth_image.npy"}, '
                  '"feelings": '
                  ...
                  '"color_image": '
                    '{"width": 10, '
                    '"height": 20, '
                    '"data": "tmpdir/raw_data/49/1576237618000/color_image"}, '
                  '"depth_image": '
                    '{"width": 5, '
                    '"height": 7, '
                    '"data": "tmpdir/raw_data/49/1576237618000/depth_image.npy"}, '
                  '"feelings": '
...
COLOR_IMAGE_JSON = ['{"datetime": "1576237612000", "user_id": 49, '
                    '"data": {"path": "tmpdir/results/49/1576237612000/color_image.jpg"}}',
                    '{"datetime": "1576237618000", "user_id": 49, '
                    '"data": {"path": "tmpdir/results/49/1576237618000/color_image.jpg"}}']
DEPTH_IMAGE_JSON = ['{"datetime": "1576237612000", "user_id": 49, '
                    '"data": {"path": "tmpdir/results/49/1576237612000/depth_image.jpg"}}',
                    '{"datetime": "1576237618000", "user_id": 49, '
                    '"data": {"path": "tmpdir/results/49/1576237618000/depth_image.jpg"}}']
